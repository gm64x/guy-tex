...
\begin{table}[!htbp]
	...
	\begin{tabular}{| >{\centering}m{2in} | >{\centering}m{2in} | >{\centering\arraybackslash}m{2in} | }
		...
		\multicolumn{2}{|l|}{\specialcell{Palavras-chave:\\grafo de fluxo de controle; complexidade ciclomática;\\análise estática; teste estrutural.}} & \getpagerefnumber{LastPage}\ páginas \\
		\hline
	\end{tabular}
\end{table}
\FloatBarrier
