...
A ferramenta foi implementada como uma extensão para \textit{Visual Studio Code}, com o objetivo de integrar a análise de fluxo de controle diretamente ao ambiente de desenvolvimento. E em sua versão atual, tem como foco a análise de arquivos Python.
