...
Os resultados obtidos são apresentados no Capítulo \ref{cap:04}, com o detalhamento da implementação do GUY e da validação das funcionalidades desenvolvidas.
