...
O Grafo de Fluxo de Controle (GFC) é a representação gráfica fundamental para a análise estrutural. Ele modela a lógica do programa como um grafo dirigido, em que os \textbf{nós} representam blocos de processamento sequencial (sem desvios) e as \textbf{arestas} representam o fluxo de controle entre esses nós.
